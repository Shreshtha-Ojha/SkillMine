...
export default function CreateBlogPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-zinc-950 py-12 px-4">
        <div className="w-full max-w-3xl bg-zinc-900 rounded-3xl shadow-2xl p-10 border-2 border-[rgba(126,16,44,0.12)] mb-8">
          <h1 className="text-3xl font-bold text-[var(--color-accent)] mb-8 text-center">Create a Professional Blog</h1>
      ...
      {showPreview && (
        <div className="w-full max-w-3xl bg-white rounded-3xl shadow-xl p-10 border-2 border-[rgba(126,16,44,0.12)] mb-8">
